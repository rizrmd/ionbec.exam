...
class SampleClientSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Regular users removed - only admin users needed for multi-tenant setup
        ...
        $this->command->info('User: user@acme.com / AcmeUser@123');
        $this->command->info('');
        ...
        $this->command->info('User: user@techedu.com / TechEduUser@123');
    }
}
