...
// Get scorer role ID (should be ID: 2)
$scorerRoleId = 2;
$allUsernames = array_keys($passwords);
    ...
    try {
        ...
        if ($user) {
            ...
            if (!$existingRole) {
                ...
                echo "- {$username} already has role ID: {$existingRole->role_id}\n";
            }
        }
    } catch (Exception $e) {
...
echo "\nDone! All users have been created and assigned roles.\n";