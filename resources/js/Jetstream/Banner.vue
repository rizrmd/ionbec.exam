...
<template>
  <div>
    <div v-if="show && message" :class="{ 'bg-green-500': style === 'success', 'bg-red-700': style === 'danger' , 'rounded-md': true }">
      <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-4">
        <div class="flex items-center justify-between flex-wrap">
          <div class="w-0 flex-1 flex items-center min-w-0">
            <span :class="{ 'bg-green-600': style === 'success', 'bg-red-700': style === 'danger' }" class="flex p-2 rounded-lg">
              <svg
                v-if="style === 'success'"
